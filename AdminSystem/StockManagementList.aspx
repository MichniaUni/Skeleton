...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="btnReturnToMainMenu" runat="server" OnClick="btnReturnToMainMenu_Click" style="z-index: 1; left: 349px; top: 375px; position: absolute; width: 183px" Text="Return To Main Menu" />
        </p>
    </form>
</body>
</html>
