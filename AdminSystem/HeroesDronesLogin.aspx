<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeroesDronesLogin.aspx.cs" Inherits="HeroesDronesLogin" %>
...
<body style="height: 364px">
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:Button ID="btnLogin" runat="server" OnClick="btnLogin_Click" style="z-index: 1; left: 47px; top: 270px; position: absolute; right: 793px" Text="Login" Width="100px" />
        </p>
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 205px; top: 270px; position: absolute; width: 100px" Text="Cancel" OnClick="btnCancel_Click" />
    </form>
</body>
</html>
