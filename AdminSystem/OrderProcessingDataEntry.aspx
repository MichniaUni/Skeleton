...
<body style="height: 345px; width: 513px">
    ...
    <form id="form1" runat="server">
        <div style="height: 341px; width: 685px">
            ...
            <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 255px; top: 442px; position: absolute; height: 33px; width: 91px; " Text="OK" />
        </div>
        ...
        <asp:Button ID="btnCancel" runat="server" height="33px" style="z-index: 1; left: 417px; top: 443px; position: absolute" Text="Cancel" width="91px" />
        <p style="height: 33px; width: 91px">
            &nbsp;</p>
        <p>
            &nbsp;</p>
        <p>
